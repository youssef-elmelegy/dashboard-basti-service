...
export interface NotificationsListProps {
  /** Show the header (title + total count). Defaults to true. */
  showHeader?: boolean;
  /** Show the filters and mark-all-as-read controls. Defaults to true. */
  showControls?: boolean;
  /** Enable infinite scroll on the main scroll container. Defaults to true. */
  enableInfiniteScroll?: boolean;
  /** Override the page size. Defaults to 20. */
  pageSize?: number;
