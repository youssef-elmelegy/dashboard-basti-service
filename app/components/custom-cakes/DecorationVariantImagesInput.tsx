...
interface DecorationVariantImagesInputProps {
  variantImages: DecorationVariantImageData[];
  onVariantImagesChange: (images: DecorationVariantImageData[]) => void;
}

export function DecorationVariantImagesInput({
  variantImages,
  onVariantImagesChange,
}: DecorationVariantImagesInputProps) {
  ...
  const handleImageUpload = async (
    ...
    try {
      ...
      const result = await uploadCakeImage(file, UPLOAD_FOLDERS.decorationVariants);
  ...
  const getVariantImage = (
    shapeId: string,
  ): DecorationVariantImageData | undefined => {
